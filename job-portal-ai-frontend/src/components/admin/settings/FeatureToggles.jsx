  ...
  return (
    <div className="space-y-6">
              ...
              >
                <div className="flex-1 pr-8">
                  <div className="flex items-center gap-2">
                    ...
                    {feature.badge && (
                      <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${feature.badgeColor}`}>
                        {feature.badge}
                      </span>
                    )}
                  </div>
      ...
      <div className="flex justify-end gap-3">
        <Button variant="outline" className="border-slate-200 text-slate-600">Reset to Defaults</Button>
