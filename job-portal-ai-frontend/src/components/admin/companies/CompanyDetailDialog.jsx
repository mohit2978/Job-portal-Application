...
import {
  Building2, Globe, Mail, Phone, Calendar, Users,
  ShieldCheck, Ban, ExternalLink, MapPin, Hash,
} from "lucide-react"
        ...
        <div className="pt-8 px-6 pb-6 space-y-5">
          <DialogHeader className="text-left space-y-1">
            <div className="flex items-start justify-between gap-4">
              <div>
                <DialogTitle className="text-xl font-bold text-slate-900">{company.name}</DialogTitle>
                {company.tagline && (
          ...
          {company.description && (
            <div>
              <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5">About</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <InfoRow icon={Calendar} label="Founded"         value={company.foundedYear ? String(company.foundedYear) : null} />
            <InfoRow icon={Hash}     label="Registration No." value={company.registrationNumber} />
            <InfoRow icon={Users}    label="Owner ID"        value={company.ownerId ? `#${company.ownerId}` : null} />
          </div>
          ...
          {company.socialLinks?.length > 0 && (
            <div>
              <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2">Social Links</p>
