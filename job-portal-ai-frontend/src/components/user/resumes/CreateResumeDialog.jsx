...
/**
 * CreateResumeDialog Component
 * Renders a dialog prompting the user to name a new resume, choose a preview template,
 * configure its initial visibility status, and mark if it should be their default resume version.
 */
