        ...
        <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-12 mb-5">
          ...
          <div className="flex-1 pb-1 z-10 bg-brand p-2 rounded-md">
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              {user?.verified && <CheckCircle2 className="h-5 w-5 text-white" />}
            </div>
          ...
          {missingItems.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-3">
              {missingItems.map((item) => (
                <span key={item} className="inline-flex items-center gap-1 text-xs text-orange-600 bg-orange-50 border border-orange-200 px-2.5 py-1 rounded-full">
