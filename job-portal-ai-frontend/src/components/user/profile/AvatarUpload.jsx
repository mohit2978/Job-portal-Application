  ...
  return (
    <div className="relative group shrink-0">
      ...
      <button
        ...
        onClick={() => fileRef.current?.click()}
        disabled={uploading}
        className="absolute -bottom-1.5 -right-1.5 h-7 w-7 rounded-full bg-brand border-2 border-white shadow-md flex items-center justify-center cursor-pointer hover:bg-brand/80 transition-colors disabled:opacity-50 focus:outline-none"
      >
