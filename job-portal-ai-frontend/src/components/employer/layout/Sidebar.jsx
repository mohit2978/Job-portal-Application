  ...
  return (
    ...
    >
        ...
        {!collapsed ? (
          <Link to="/employer/dashboard" className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-sm font-bold text-white truncate">HIREKRO.AI</p>
      ...
      <Button
        ...
        className="hidden lg:flex absolute -right-3 top-[4.5rem] z-10 h-6 w-6 rounded-full border border-slate-700 bg-slate-900 text-slate-400 hover:bg-slate-800 hover:text-white shadow-md"
      >
